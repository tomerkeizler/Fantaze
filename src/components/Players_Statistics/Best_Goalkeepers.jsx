...
const Best_Goalkeepers = () => {
    const [isLoading, setIsLoading] = useState(true);
    const [teams, setTeams] = useState([]);
    const [allStats, setAllStats] = useState([]);
    const [bestGoalkeepers, setBestGoalkeepers] = useState([]);
    ...
    const setItems = (list) => {
        ...
        setBestGoalkeepers(list[BEST_GOALKEEPER_PLACE]);
        setIsLoading(false);
    ...
    const emptyRows = rowsPerPage - Math.min(rowsPerPage, bestGoalkeepers.length - page * rowsPerPage);
                                        ...
                                        >
                                            <TableHead>
                                                <TableRow>
                                                    ...
                                                    <StyledTableCell align="center">Goals Conceded</StyledTableCell>
                                                    <StyledTableCell align="center">Games Played</StyledTableCell>
                                                    <StyledTableCell align="center">Goals Conceded Per Game</StyledTableCell>
                                                </TableRow>
                                            </TableHead>
                                            <TableBody>
                                                {bestGoalkeepers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                                                    .map((player, index) => {
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                <StyledTableCell align="center">{player.name}</StyledTableCell>
                                                                <StyledTableCell align="center">{player.score.conceded_goals}</StyledTableCell>
                                                                <StyledTableCell align="center">{player.score.games_played}</StyledTableCell>
                                                                <StyledTableCell align="center">{player.score.goals_per_game}</StyledTableCell>
                                                            </TableRow>
                                                        );
                                                    })}
                                                {emptyRows > 0 && (
...
export default Best_Goalkeepers;