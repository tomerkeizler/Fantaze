...
const Top_Scorers = () => {
    ...
    const setItems = (list) => {
        ...
        setTopScorers(list[TOP_SCORERS_PLACE]);
        setIsLoading(false);
    ...
    const emptyRows = rowsPerPage - Math.min(rowsPerPage, topScorers.length - page * rowsPerPage);
                                ...
                                <Paper elevation={20} className={classes.paper}>
                                    <TableContainer className={classes.container}>
                                        ...
                                        >
                                            ...
                                            <TableBody>
                                                {topScorers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                                                    .map((player, index) => {
